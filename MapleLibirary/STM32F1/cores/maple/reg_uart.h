...
//    T_UART_RBR localVal = hwp_uart->rbr_thr_dll.rbr;
    ...
    *rbr_msb_9thbit = hwp_uart->rbr_thr_dll.rbr.bit_field.rbr_msb_9thbit;
    *rbr_lsb_8bits = hwp_uart->rbr_thr_dll.rbr.bit_field.rbr_lsb_8bits;
}
...
//    T_UART_DLL localVal = hwp_uart->rbr_thr_dll.dll;
    ...
    *divisor_latch_low = hwp_uart->rbr_thr_dll.dll.bit_field.divisor_latch_low;
}
...
//    T_UART_DLH localVal = hwp_uart->dlh_ier.dlh;
    ...
    *divisor_latch_high = hwp_uart->dlh_ier.dlh.bit_field.divisor_latch_high;
}
...
//    T_UART_IER localVal = hwp_uart->dlh_ier.ier;
    ...
    *ptime = hwp_uart->dlh_ier.ier.bit_field.ptime;
    *edssi = hwp_uart->dlh_ier.ier.bit_field.edssi;
    *elsi = hwp_uart->dlh_ier.ier.bit_field.elsi;
    *etbei = hwp_uart->dlh_ier.ier.bit_field.etbei;
    *erbfi = hwp_uart->dlh_ier.ier.bit_field.erbfi;
}
...
//    T_UART_IIR localVal = hwp_uart->iir_fcr.iir;
    ...
    *fifose = hwp_uart->iir_fcr.iir.bit_field.fifose;
    *iid = hwp_uart->iir_fcr.iir.bit_field.iid;
}
...
//    T_UART_LCR localVal = hwp_uart->lcr;
    ...
    *dlab = hwp_uart->lcr.bit_field.dlab;
    *break_ = hwp_uart->lcr.bit_field.break_;
    *stick_parity = hwp_uart->lcr.bit_field.stick_parity;
    *eps = hwp_uart->lcr.bit_field.eps;
    *pen = hwp_uart->lcr.bit_field.pen;
    *stop = hwp_uart->lcr.bit_field.stop;
    *dls = hwp_uart->lcr.bit_field.dls;
}
...
//    T_UART_MCR localVal = hwp_uart->mcr;
    ...
    *sire = hwp_uart->mcr.bit_field.sire;
    *afce = hwp_uart->mcr.bit_field.afce;
    *loopback = hwp_uart->mcr.bit_field.loopback;
    *out2 = hwp_uart->mcr.bit_field.out2;
    *out1 = hwp_uart->mcr.bit_field.out1;
    *rts = hwp_uart->mcr.bit_field.rts;
    *dtr = hwp_uart->mcr.bit_field.dtr;
}
...
//    T_UART_LSR localVal = hwp_uart->lsr;
    ...
    *addr_rcvd = hwp_uart->lsr.bit_field.addr_rcvd;
    *rfe = hwp_uart->lsr.bit_field.rfe;
    *temt = hwp_uart->lsr.bit_field.temt;
    *thre = hwp_uart->lsr.bit_field.thre;
    *bi = hwp_uart->lsr.bit_field.bi;
    *fe = hwp_uart->lsr.bit_field.fe;
    *pe = hwp_uart->lsr.bit_field.pe;
    *oe = hwp_uart->lsr.bit_field.oe;
    *dr = hwp_uart->lsr.bit_field.dr;
}
...
//    T_UART_MSR localVal = hwp_uart->msr;
    ...
    *dcd = hwp_uart->msr.bit_field.dcd;
    *ri = hwp_uart->msr.bit_field.ri;
    *dsr = hwp_uart->msr.bit_field.dsr;
    *cts = hwp_uart->msr.bit_field.cts;
    *ddcd = hwp_uart->msr.bit_field.ddcd;
    *teri = hwp_uart->msr.bit_field.teri;
    *ddsr = hwp_uart->msr.bit_field.ddsr;
    *dcts = hwp_uart->msr.bit_field.dcts;
}
...
//    T_UART_SCR localVal = hwp_uart->scr;
    ...
    *scratchpad = hwp_uart->scr.bit_field.scratchpad;
}
...
//    T_UART_FAR localVal = hwp_uart->far;
    ...
    *fifo_access_mode = hwp_uart->far.bit_field.fifo_access_mode;
}
...
//    T_UART_TFR localVal = hwp_uart->tfr;
    ...
    *transmit_fifo_read = hwp_uart->tfr.bit_field.transmit_fifo_read;
}
...
//    T_UART_USR localVal = hwp_uart->usr;
    ...
    *rff = hwp_uart->usr.bit_field.rff;
    *rfne = hwp_uart->usr.bit_field.rfne;
    *tfe = hwp_uart->usr.bit_field.tfe;
    *tfnf = hwp_uart->usr.bit_field.tfnf;
    *busy = hwp_uart->usr.bit_field.busy;
}
...
//    T_UART_HTX localVal = hwp_uart->htx;
    ...
    *halt_tx = hwp_uart->htx.bit_field.halt_tx;
}
...
//    T_UART_DLF localVal = hwp_uart->dlf;
    ...
    *dlf = hwp_uart->dlf.bit_field.dlf;
}
...
//    T_UART_CPR localVal = hwp_uart->cpr;
    ...
    *fifo_mode = hwp_uart->cpr.bit_field.fifo_mode;
    *dma_extra = hwp_uart->cpr.bit_field.dma_extra;
    *uart_add_encoded_params = hwp_uart->cpr.bit_field.uart_add_encoded_params;
    *shadow = hwp_uart->cpr.bit_field.shadow;
    *fifo_stat = hwp_uart->cpr.bit_field.fifo_stat;
    *fifo_access = hwp_uart->cpr.bit_field.fifo_access;
    *new_feat = hwp_uart->cpr.bit_field.new_feat;
    *sir_lp_mode = hwp_uart->cpr.bit_field.sir_lp_mode;
    *sir_mode = hwp_uart->cpr.bit_field.sir_mode;
    *thre_mode = hwp_uart->cpr.bit_field.thre_mode;
    *afce_mode = hwp_uart->cpr.bit_field.afce_mode;
    *apb_data_width = hwp_uart->cpr.bit_field.apb_data_width;
}
...
//    T_UART_UCV localVal = hwp_uart->ucv;
    ...
    *uart_component_version = hwp_uart->ucv.bit_field.uart_component_version;
}
...
//    T_UART_CTR localVal = hwp_uart->ctr;
    ...
    *peripheral_id = hwp_uart->ctr.bit_field.peripheral_id;
}
