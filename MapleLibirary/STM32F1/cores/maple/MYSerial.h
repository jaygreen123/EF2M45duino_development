...
public:
	...
	size_m write(uint8 *buf);
	size_m write(const void *buf, uint32 size);

	size_m print(char);
	size_m print(const char *);
	size_m print(uint8 *);
//	size_m print(uint8, uint8 = DEC);
//	size_m print(unsigned short, uint8 = DEC);
//	size_m print(unsigned int, uint8 = DEC);
//	size_m print(unsigned long, uint8 = DEC);
//	size_m print(unsigned long long, uint8 = DEC);
//	size_m print(short, uint8 = DEC);
//	size_m print(int, uint8 = DEC);
//	size_m print(long, uint8 = DEC);
	size_m print(long long, uint8 = DEC);

	size_m println(void);
	size_m println(char );
	size_m println(const char *);
	size_m println(uint8 *);
//	size_m println(uint8, uint8 = DEC);
//	size_m println(unsigned short, uint8 = DEC);
//	size_m println(unsigned int, uint8 = DEC);
//	size_m println(unsigned long, uint8 = DEC);
//	size_m println(unsigned long long, uint8 = DEC);
//	size_m println(short, uint8 = DEC);
//	size_m println(int, uint8 = DEC);
//	size_m println(long, uint8 = DEC);
//	size_m println(long long, uint8 = DEC);
...
private:
	size_m printNumber(unsigned long long, uint8);
