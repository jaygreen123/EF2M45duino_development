...
//    T_SYSC_CPU_DIV_PARA localVal = hwp_sysc_cpu->div_para;
    ...
    *timer1_div_para_m1 = hwp_sysc_cpu->div_para.bit_field.timer1_div_para_m1;
    *timer0_div_para_m1 = hwp_sysc_cpu->div_para.bit_field.timer0_div_para_m1;
    *pclk0_div_para_m1 = hwp_sysc_cpu->div_para.bit_field.pclk0_div_para_m1;
}
...
//    T_SYSC_CPU_SW_CLKG localVal = hwp_sysc_cpu->sw_clkg;
    ...
    *dma_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.dma_gate_en;
    *cache_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.cache_gate_en;
    *timer2_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.timer2_gate_en;
    *timer1_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.timer1_gate_en;
    *timer_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.timer_gate_en;
    *wdt_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.wdt_gate_en;
    *uart_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.uart_gate_en;
    *i2c0_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.i2c0_gate_en;
    *i2c1_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.i2c1_gate_en;
    *spi_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.spi_gate_en;
    *gpio_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.gpio_gate_en;
    *i2s_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.i2s_gate_en;
    *adcc_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.adcc_gate_en;
    *cfg_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.cfg_gate_en;
    *qspi_gate_en = hwp_sysc_cpu->sw_clkg.bit_field.qspi_gate_en;
}
...
//    T_SYSC_CPU_SW_RSTN localVal = hwp_sysc_cpu->sw_rstn;
    ...
    *srstn_dma = hwp_sysc_cpu->sw_rstn.bit_field.srstn_dma;
    *srstn_cache = hwp_sysc_cpu->sw_rstn.bit_field.srstn_cache;
    *srstn_timer = hwp_sysc_cpu->sw_rstn.bit_field.srstn_timer;
    *srstn_wdt = hwp_sysc_cpu->sw_rstn.bit_field.srstn_wdt;
    *srstn_uart = hwp_sysc_cpu->sw_rstn.bit_field.srstn_uart;
    *srstn_spi = hwp_sysc_cpu->sw_rstn.bit_field.srstn_spi;
    *srstn_i2c0 = hwp_sysc_cpu->sw_rstn.bit_field.srstn_i2c0;
    *srstn_i2c1 = hwp_sysc_cpu->sw_rstn.bit_field.srstn_i2c1;
    *srstn_gpio = hwp_sysc_cpu->sw_rstn.bit_field.srstn_gpio;
    *srstn_i2s = hwp_sysc_cpu->sw_rstn.bit_field.srstn_i2s;
    *srstn_adcc = hwp_sysc_cpu->sw_rstn.bit_field.srstn_adcc;
    *srstn_cfg = hwp_sysc_cpu->sw_rstn.bit_field.srstn_cfg;
    *srstn_qspi = hwp_sysc_cpu->sw_rstn.bit_field.srstn_qspi;
}
...
//    T_SYSC_CPU_GPIEN localVal = hwp_sysc_cpu->gpien;
    ...
    *gpioa_en_1 = hwp_sysc_cpu->gpien.bit_field.gpioa_en_1;
    *gpioa_en_0 = hwp_sysc_cpu->gpien.bit_field.gpioa_en_0;
}
...
//    T_SYSC_CPU_FUNC_EN localVal = hwp_sysc_cpu->func_en;
    ...
    *func_ien = hwp_sysc_cpu->func_en.bit_field.func_ien;
}
...
//    T_SYSC_CPU_FUNC_ISEL_07 localVal = hwp_sysc_cpu->func_isel_07;
    ...
    *func_io07_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io07_sel;
    *func_io06_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io06_sel;
    *func_io05_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io05_sel;
    *func_io04_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io04_sel;
    *func_io03_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io03_sel;
    *func_io02_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io02_sel;
    *func_io01_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io01_sel;
    *func_io00_sel = hwp_sysc_cpu->func_isel_07.bit_field.func_io00_sel;
}
...
//    T_SYSC_CPU_FUNC_ISEL_15 localVal = hwp_sysc_cpu->func_isel_15;
    ...
    *func_io15_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io15_sel;
    *func_io14_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io14_sel;
    *func_io13_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io13_sel;
    *func_io12_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io12_sel;
    *func_io11_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io11_sel;
    *func_io10_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io10_sel;
    *func_io09_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io09_sel;
    *func_io08_sel = hwp_sysc_cpu->func_isel_15.bit_field.func_io08_sel;
}
...
//    T_SYSC_CPU_MCU_STCALIB localVal = hwp_sysc_cpu->mcu_stcalib;
    ...
    *mcu_stcalib = hwp_sysc_cpu->mcu_stcalib.bit_field.mcu_stcalib;
}
