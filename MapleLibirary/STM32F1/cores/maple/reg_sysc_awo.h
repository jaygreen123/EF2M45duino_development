...
//    T_SYSC_AWO_DIV_PARA localVal = hwp_sysc_awo->div_para;
    ...
    *rtc_div_para_m1 = hwp_sysc_awo->div_para.bit_field.rtc_div_para_m1;
    *pclk1_div_para_m1 = hwp_sysc_awo->div_para.bit_field.pclk1_div_para_m1;
    *hclk_div_para_m1 = hwp_sysc_awo->div_para.bit_field.hclk_div_para_m1;
}
...
//    T_SYSC_AWO_SW_CLKG localVal = hwp_sysc_awo->sw_clkg;
    ...
    *swclkg_wic = hwp_sysc_awo->sw_clkg.bit_field.swclkg_wic;
    *swclkg_rtc = hwp_sysc_awo->sw_clkg.bit_field.swclkg_rtc;
}
...
//    T_SYSC_AWO_SW_RSTN localVal = hwp_sysc_awo->sw_rstn;
    ...
    *srstn_all = hwp_sysc_awo->sw_rstn.bit_field.srstn_all;
    *srstn_rtc = hwp_sysc_awo->sw_rstn.bit_field.srstn_rtc;
    *srstn_wic = hwp_sysc_awo->sw_rstn.bit_field.srstn_wic;
    *srstn_pmu = hwp_sysc_awo->sw_rstn.bit_field.srstn_pmu;
}
...
//    T_SYSC_AWO_CLK_SEL localVal = hwp_sysc_awo->clk_sel;
    ...
    *clk_src_sel = hwp_sysc_awo->clk_sel.bit_field.clk_src_sel;
}
...
//    T_SYSC_AWO_IO_RET localVal = hwp_sysc_awo->io_ret;
    ...
    *io_ctrl_sel = hwp_sysc_awo->io_ret.bit_field.io_ctrl_sel;
    *io_stat_unret_pmu = hwp_sysc_awo->io_ret.bit_field.io_stat_unret_pmu;
    *io_stat_ret_pmu = hwp_sysc_awo->io_ret.bit_field.io_stat_ret_pmu;
}
...
//    T_SYSC_AWO_EXT_INTR_SENCE localVal = hwp_sysc_awo->ext_intr_sence;
    ...
    *ext_inrp_sense_15 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_15;
    *ext_inrp_sense_14 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_14;
    *ext_inrp_sense_13 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_13;
    *ext_inrp_sense_12 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_12;
    *ext_inrp_sense_11 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_11;
    *ext_inrp_sense_10 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_10;
    *ext_inrp_sense_9 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_9;
    *ext_inrp_sense_8 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_8;
    *ext_inrp_sense_7 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_7;
    *ext_inrp_sense_6 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_6;
    *ext_inrp_sense_5 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_5;
    *ext_inrp_sense_4 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_4;
    *ext_inrp_sense_3 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_3;
    *ext_inrp_sense_2 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_2;
    *ext_inrp_sense_1 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_1;
    *ext_inrp_sense_0 = hwp_sysc_awo->ext_intr_sence.bit_field.ext_inrp_sense_0;
}
...
//    T_SYSC_AWO_EXT_INTR_EN localVal = hwp_sysc_awo->ext_intr_en;
    ...
    *pin_is_inrp_src = hwp_sysc_awo->ext_intr_en.bit_field.pin_is_inrp_src;
    *ext_inrp_en = hwp_sysc_awo->ext_intr_en.bit_field.ext_inrp_en;
}
...
//    T_SYSC_AWO_INTR_STAT localVal = hwp_sysc_awo->intr_stat;
    ...
    *ext_rawinrp_value = hwp_sysc_awo->intr_stat.bit_field.ext_rawinrp_value;
    *ext_inrp_value_r = hwp_sysc_awo->intr_stat.bit_field.ext_inrp_value_r;
}
...
//    T_SYSC_AWO_SWC_TIME localVal = hwp_sysc_awo->swc_time;
    ...
    *pmu_seq_time = hwp_sysc_awo->swc_time.bit_field.pmu_seq_time;
    *clk_swc_dly = hwp_sysc_awo->swc_time.bit_field.clk_swc_dly;
    *ldswc_dly = hwp_sysc_awo->swc_time.bit_field.ldswc_dly;
    *ldsetup_time = hwp_sysc_awo->swc_time.bit_field.ldsetup_time;
    *retsw_delay = hwp_sysc_awo->swc_time.bit_field.retsw_delay;
    *pmu_enable = hwp_sysc_awo->swc_time.bit_field.pmu_enable;
}
...
//    T_SYSC_AWO_CFG_DONE_GWE localVal = hwp_sysc_awo->cfg_done_gwe;
    ...
    *r2_cfg_done_gwe = hwp_sysc_awo->cfg_done_gwe.bit_field.r2_cfg_done_gwe;
}
...
//    T_SYSC_AWO_RAM_LOAD_EN localVal = hwp_sysc_awo->ram_load_en;
    ...
    *pib_rstn_en = hwp_sysc_awo->ram_load_en.bit_field.pib_rstn_en;
    *sg12r_xtal_en = hwp_sysc_awo->ram_load_en.bit_field.sg12r_xtal_en;
    *mcu_need_wait_cfgdone = hwp_sysc_awo->ram_load_en.bit_field.mcu_need_wait_cfgdone;
    *wakeup_flag = hwp_sysc_awo->ram_load_en.bit_field.wakeup_flag;
    *sleep_out = hwp_sysc_awo->ram_load_en.bit_field.sleep_out;
    *ram1_load_en = hwp_sysc_awo->ram_load_en.bit_field.ram1_load_en;
    *ram0_load_en = hwp_sysc_awo->ram_load_en.bit_field.ram0_load_en;
}
...
//    T_SYSC_AWO_FLASH_MODE localVal = hwp_sysc_awo->flash_mode;
    ...
    *flash_mode = hwp_sysc_awo->flash_mode.bit_field.flash_mode;
}
...
//    T_SYSC_AWO_UCR_REG localVal = hwp_sysc_awo->ucr_reg;
    ...
    *ucr_reg = hwp_sysc_awo->ucr_reg.bit_field.ucr_reg;
}
...
//    T_SYSC_AWO_TRIM_REG localVal = hwp_sysc_awo->trim_reg;
    ...
    *trim_reg = hwp_sysc_awo->trim_reg.bit_field.trim_reg;
}
...
//    T_SYSC_AWO_GPIO_L_PU_REG localVal = hwp_sysc_awo->gpio_l_pu_reg;
    ...
    *gpil_pu_n = hwp_sysc_awo->gpio_l_pu_reg.bit_field.gpil_pu_n;
}
...
//    T_SYSC_AWO_GPIO_L_PD_REG localVal = hwp_sysc_awo->gpio_l_pd_reg;
    ...
    *gpil_pd = hwp_sysc_awo->gpio_l_pd_reg.bit_field.gpil_pd;
}
